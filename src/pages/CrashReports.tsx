...
//styled
const CrashReportsWrap = styled.div`
  position: relative;
`;

const CrashReports: React.FC<RouteComponentProps> = (): JSX.Element => {
  return (
    <PageFade>
      <CrashReportsWrap>
        <Header>
          <Heading as="h1" heading4 marginBottom="0px" fontWeight="500">Crash Reports</Heading>
        </Header>
        <Card>
          <Heading as="h2" heading1 marginBottom="8px">Crash Reports</Heading>
