...
const Users: React.FC<RouteComponentProps> = (): JSX.Element => {
  return (
    <PageFade>
      <UsersWrap>
        <Header>
          <Heading as="h1" heading4 marginBottom="0px" fontWeight="500">Users</Heading>
        </Header>
        <Card>
          <Heading as="h2" heading1 marginBottom="8px">Users</Heading>
